...
# CDKTN prebuilt bindings for kreuzwerker/docker provider version 4.3.0

This repo builds and publishes the [Terraform docker provider](https://registry.terraform.io/providers/kreuzwerker/docker/4.3.0/docs) bindings for [CDK Terrain](https://cdktn.io).
...
- [Terraform docker provider](https://registry.terraform.io/providers/kreuzwerker/docker/4.3.0)
