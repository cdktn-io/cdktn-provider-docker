...
```go
import "github.com/cdktn-io/cdktn-provider-docker-go/docker/v16/datadockerimage"
...
| <code><a href="#@cdktn/provider-docker.dataDockerImage.DataDockerImageConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/data-sources/image#id DataDockerImage#id}. |
