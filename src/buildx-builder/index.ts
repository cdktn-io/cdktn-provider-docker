...
// https://registry.terraform.io/providers/kreuzwerker/docker/4.5.0/docs/resources/buildx_builder
...
export class BuildxBuilder extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing BuildxBuilder that should be imported. Refer to the {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.5.0/docs/resources/buildx_builder#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.5.0/docs/resources/buildx_builder docker_buildx_builder} Resource
  *
  * @param scope The scope in which to define this construct
