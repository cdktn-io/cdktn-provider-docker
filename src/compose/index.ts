...
// https://registry.terraform.io/providers/kreuzwerker/docker/4.3.0/docs/resources/compose
...
export class Compose extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Compose that should be imported. Refer to the {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.3.0/docs/resources/compose#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the Compose to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "docker_compose", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.3.0/docs/resources/compose docker_compose} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _removeOrphans?: boolean | cdktn.IResolvable; 
  public get removeOrphans() {
    return this.getBooleanAttribute('remove_orphans');
  }
  public set removeOrphans(value: boolean | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      env_files: cdktn.listMapper(cdktn.stringToTerraform, false)(this._envFiles),
      profiles: cdktn.listMapper(cdktn.stringToTerraform, false)(this._profiles),
      project_directory: cdktn.stringToTerraform(this._projectDirectory),
      project_name: cdktn.stringToTerraform(this._projectName),
      remove_orphans: cdktn.booleanToTerraform(this._removeOrphans),
      wait: cdktn.booleanToTerraform(this._wait),
      wait_timeout: cdktn.stringToTerraform(this._waitTimeout),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      env_files: {
        value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(this._envFiles),
        isBlock: false,
        type: "list",
        storageClassType: "stringList",
      },
      profiles: {
        value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(this._profiles),
        isBlock: false,
        type: "list",
        storageClassType: "stringList",
      },
      project_directory: {
        value: cdktn.stringToHclTerraform(this._projectDirectory),
        isBlock: false,
        type: "simple",
      ...
      remove_orphans: {
        value: cdktn.booleanToHclTerraform(this._removeOrphans),
        isBlock: false,
        type: "simple",
      ...
      wait_timeout: {
        value: cdktn.stringToHclTerraform(this._waitTimeout),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
