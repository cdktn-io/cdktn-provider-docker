...
// https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/container
...
export interface ContainerConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  readonly deviceCgroupRules?: string[];
  /**
  * DNS servers to use.
  *
...
export class Container extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Container that should be imported. Refer to the {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/container#import import section} in the documentation of this resource for the id to use
  ...
  */
  public constructor(scope: Construct, id: string, config: ContainerConfig) {
    ...
    this._deviceCgroupRules = config.deviceCgroupRules;
  ...
  // device_cgroup_rules - computed: false, optional: true, required: false
  private _deviceCgroupRules?: string[]; 
  public get deviceCgroupRules() {
    return cdktn.Fn.tolist(this.getListAttribute('device_cgroup_rules'));
  }
  public set deviceCgroupRules(value: string[]) {
    this._deviceCgroupRules = value;
  }
  public resetDeviceCgroupRules() {
    this._deviceCgroupRules = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get deviceCgroupRulesInput() {
    return this._deviceCgroupRules;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      device_cgroup_rules: cdktn.listMapper(cdktn.stringToTerraform, false)(this._deviceCgroupRules),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      device_cgroup_rules: {
        value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(this._deviceCgroupRules),
        isBlock: false,
        type: "set",
        storageClassType: "stringList",
      },
