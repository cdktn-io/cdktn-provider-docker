...
// https://registry.terraform.io/providers/kreuzwerker/docker/3.9.0/docs/data-sources/registry_image
...
export class DataDockerRegistryImage extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDockerRegistryImage that should be imported. Refer to the {@link https://registry.terraform.io/providers/kreuzwerker/docker/3.9.0/docs/data-sources/registry_image#import import section} in the documentation of this resource for the id to use
