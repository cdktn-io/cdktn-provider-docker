...
// https://registry.terraform.io/providers/kreuzwerker/docker/4.5.0/docs
...
export class DockerProvider extends cdktn.TerraformProvider {
  ...
  * @param importFromId The id of the existing DockerProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.5.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.5.0/docs docker} Resource
  *
  * @param scope The scope in which to define this construct
