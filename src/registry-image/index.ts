...
// https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image
...
export interface RegistryImageConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#id RegistryImage#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#insecure_skip_verify RegistryImage#insecure_skip_verify}
  */
  readonly insecureSkipVerify?: boolean | cdktn.IResolvable;
  /**
  * If true, then the Docker image won't be deleted on destroy operation. If this is false, it will delete the image from the docker registry on destroy operation. Defaults to `false`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#keep_remotely RegistryImage#keep_remotely}
  */
  readonly keepRemotely?: boolean | cdktn.IResolvable;
  /**
  * The name of the Docker image.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#name RegistryImage#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#triggers RegistryImage#triggers}
  */
  readonly triggers?: { [key: string]: string };
  /**
  * auth_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#auth_config RegistryImage#auth_config}
  */
  readonly authConfig?: RegistryImageAuthConfig;
  /**
  * build block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#build RegistryImage#build}
  */
  readonly buildAttribute?: RegistryImageBuild;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#timeouts RegistryImage#timeouts}
  */
...
export interface RegistryImageAuthConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#address RegistryImage#address}
  */
  readonly address: string;
  /**
  * The password for the Docker registry.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#password RegistryImage#password}
  */
  readonly password?: string;
  /**
  * The username for the Docker registry.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#username RegistryImage#username}
  */
...
export interface RegistryImageBuildAuthConfig {
  ...
  * the auth token
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#auth RegistryImage#auth}
  */
  readonly auth?: string;
  /**
  * the user emal
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#email RegistryImage#email}
  */
  readonly email?: string;
  /**
  * hostname of the registry
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#host_name RegistryImage#host_name}
  */
  readonly hostName: string;
  /**
  * the identity token
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#identity_token RegistryImage#identity_token}
  */
  ...
  * the registry token
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#registry_token RegistryImage#registry_token}
  */
  readonly registryToken?: string;
  /**
  * the server address
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#server_address RegistryImage#server_address}
  */
  readonly serverAddress?: string;
  /**
  * the registry user name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#user_name RegistryImage#user_name}
  */
  readonly userName?: string;
}

export function registryImageBuildAuthConfigToTerraform(struct?: RegistryImageBuildAuthConfig | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  return {
    ...
    identity_token: cdktn.stringToTerraform(struct!.identityToken),
    password: cdktn.stringToTerraform(struct!.password),
    registry_token: cdktn.stringToTerraform(struct!.registryToken),
...
export function registryImageBuildAuthConfigToHclTerraform(struct?: RegistryImageBuildAuthConfig | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  const attrs = {
    ...
    identity_token: {
      value: cdktn.stringToHclTerraform(struct!.identityToken),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
    ...
    registry_token: {
      value: cdktn.stringToHclTerraform(struct!.registryToken),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
...
export class RegistryImageBuildAuthConfigOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): RegistryImageBuildAuthConfig | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: RegistryImageBuildAuthConfig | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class RegistryImageBuildAuthConfigList extends cdktn.ComplexList {
  public internalValue? : RegistryImageBuildAuthConfig[] | cdktn.IResolvable
...
export interface RegistryImageBuildSecrets {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#env RegistryImage#env}
  */
  readonly env?: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#src RegistryImage#src}
  */
  readonly src?: string;
}

export function registryImageBuildSecretsToTerraform(struct?: RegistryImageBuildSecrets | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  return {
    ...
    src: cdktn.stringToTerraform(struct!.src),
  }
}


export function registryImageBuildSecretsToHclTerraform(struct?: RegistryImageBuildSecrets | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  const attrs = {
    ...
    src: {
      value: cdktn.stringToHclTerraform(struct!.src),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
...
export class RegistryImageBuildSecretsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktn.IResolvable;
  ...
  */
  ...
  public get internalValue(): RegistryImageBuildSecrets | cdktn.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: RegistryImageBuildSecrets | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._env = undefined;
...
export class RegistryImageBuildSecretsList extends cdktn.ComplexList {
  public internalValue? : RegistryImageBuildSecrets[] | cdktn.IResolvable
...
export interface RegistryImageBuildUlimit {
  ...
  * soft limit
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#hard RegistryImage#hard}
  */
  ...
  * hard limit
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#soft RegistryImage#soft}
  */
  readonly soft: number;
}

export function registryImageBuildUlimitToTerraform(struct?: RegistryImageBuildUlimit | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function registryImageBuildUlimitToHclTerraform(struct?: RegistryImageBuildUlimit | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class RegistryImageBuildUlimitOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktn.IResolvable;
  ...
  */
  ...
  public get internalValue(): RegistryImageBuildUlimit | cdktn.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: RegistryImageBuildUlimit | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class RegistryImageBuildUlimitList extends cdktn.ComplexList {
  public internalValue? : RegistryImageBuildUlimit[] | cdktn.IResolvable
...
export interface RegistryImageBuild {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#additional_contexts RegistryImage#additional_contexts}
  */
  readonly additionalContexts?: string[];
  /**
  * Pairs for build-time variables in the form of `ENDPOINT : "https://example.com"`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#build_args RegistryImage#build_args}
  */
  readonly buildArgs?: { [key: string]: string };
  /**
  * BuildID is an optional identifier that can be passed together with the build request. The same identifier can be used to gracefully cancel the build with the cancel request.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#build_id RegistryImage#build_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#build_log_file RegistryImage#build_log_file}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#builder RegistryImage#builder}
  */
  readonly builder?: string;
  /**
  * External cache sources (e.g., `user/app:cache`, `type=local,src=path/to/dir`). Only supported when using a buildx builder.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#cache_from RegistryImage#cache_from}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#cache_to RegistryImage#cache_to}
  */
  readonly cacheTo?: string[];
  /**
  * Optional parent cgroup for the container
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#cgroup_parent RegistryImage#cgroup_parent}
  */
  readonly cgroupParent?: string;
  /**
  * Value to specify the build context. Currently, only a `PATH` context is supported. You can use the helper function '${path.cwd}/context-dir'. This always refers to the local working directory, even when building images on remote hosts. Please see https://docs.docker.com/build/building/context/ for more information about build contexts.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#context RegistryImage#context}
  */
  readonly context: string;
  /**
  * The length of a CPU period in microseconds
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#cpu_period RegistryImage#cpu_period}
  */
  readonly cpuPeriod?: number;
  /**
  * Microseconds of CPU time that the container can get in a CPU period
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#cpu_quota RegistryImage#cpu_quota}
  */
  readonly cpuQuota?: number;
  /**
  * CPUs in which to allow execution (e.g., `0-3`, `0`, `1`)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#cpu_set_cpus RegistryImage#cpu_set_cpus}
  */
  readonly cpuSetCpus?: string;
  /**
  * MEMs in which to allow execution (`0-3`, `0`, `1`)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#cpu_set_mems RegistryImage#cpu_set_mems}
  */
  readonly cpuSetMems?: string;
  /**
  * CPU shares (relative weight)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#cpu_shares RegistryImage#cpu_shares}
  */
  readonly cpuShares?: number;
  /**
  * Name of the Dockerfile. Defaults to `Dockerfile`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#dockerfile RegistryImage#dockerfile}
  */
  readonly dockerfile?: string;
  /**
  * A list of hostnames/IP mappings to add to the container’s /etc/hosts file. Specified in the form ["hostname:IP"]
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#extra_hosts RegistryImage#extra_hosts}
  */
  readonly extraHosts?: string[];
  /**
  * Always remove intermediate containers
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#force_remove RegistryImage#force_remove}
  */
  readonly forceRemove?: boolean | cdktn.IResolvable;
  /**
  * Isolation represents the isolation technology of a container. The supported values are 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#isolation RegistryImage#isolation}
  */
  readonly isolation?: string;
  /**
  * Set metadata for an image
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#label RegistryImage#label}
  */
  readonly label?: { [key: string]: string };
  /**
  * User-defined key/value metadata
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#labels RegistryImage#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * Set memory limit for build
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#memory RegistryImage#memory}
  */
  readonly memory?: number;
  /**
  * Total memory (memory + swap), -1 to enable unlimited swap
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#memory_swap RegistryImage#memory_swap}
  */
  readonly memorySwap?: number;
  /**
  * Set the networking mode for the RUN instructions during build
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#network_mode RegistryImage#network_mode}
  */
  readonly networkMode?: string;
  /**
  * Do not use the cache when building the image
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#no_cache RegistryImage#no_cache}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#platform RegistryImage#platform}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#provenance RegistryImage#provenance}
  */
  readonly provenance?: string;
  /**
  * Attempt to pull the image even if an older image exists locally
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#pull_parent RegistryImage#pull_parent}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#remote_context RegistryImage#remote_context}
  */
  readonly remoteContext?: string;
  /**
  * Remove intermediate containers after a successful build. Defaults to `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#remove RegistryImage#remove}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#sbom RegistryImage#sbom}
  */
  readonly sbom?: string;
  /**
  * The security options
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#security_opt RegistryImage#security_opt}
  */
  readonly securityOpt?: string[];
  /**
  * Set an ID for the build session
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#session_id RegistryImage#session_id}
  */
  readonly sessionId?: string;
  /**
  * Size of /dev/shm in bytes. The size must be greater than 0
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#shm_size RegistryImage#shm_size}
  */
  readonly shmSize?: number;
  /**
  * If true the new layers are squashed into a new image with a single new layer
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#squash RegistryImage#squash}
  */
  readonly squash?: boolean | cdktn.IResolvable;
  /**
  * Suppress the build output and print image ID on success
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#suppress_output RegistryImage#suppress_output}
  */
  readonly suppressOutput?: boolean | cdktn.IResolvable;
  /**
  * Name and optionally a tag in the 'name:tag' format
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#tag RegistryImage#tag}
  */
  readonly tag?: string[];
  /**
  * Set the target build stage to build
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#target RegistryImage#target}
  */
  readonly target?: string;
  /**
  * Force using the legacy Docker builder for image builds, even if buildx/buildkit would be available.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#use_legacy_builder RegistryImage#use_legacy_builder}
  */
  readonly useLegacyBuilder?: boolean | cdktn.IResolvable;
  /**
  * Version of the underlying builder to use
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#version RegistryImage#version}
  */
  ...
  * secrets block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#secrets RegistryImage#secrets}
  */
  readonly secrets?: RegistryImageBuildSecrets[] | cdktn.IResolvable;
  /**
  * ulimit block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#ulimit RegistryImage#ulimit}
  */
...
export function registryImageBuildToTerraform(struct?: RegistryImageBuildOutputReference | RegistryImageBuild): any {
  ...
  return {
    additional_contexts: cdktn.listMapper(cdktn.stringToTerraform, false)(struct!.additionalContexts),
    build_args: cdktn.hashMapper(cdktn.stringToTerraform)(struct!.buildArgs),
    build_id: cdktn.stringToTerraform(struct!.buildId),
    build_log_file: cdktn.stringToTerraform(struct!.buildLogFile),
    builder: cdktn.stringToTerraform(struct!.builder),
    cache_from: cdktn.listMapper(cdktn.stringToTerraform, false)(struct!.cacheFrom),
    cache_to: cdktn.listMapper(cdktn.stringToTerraform, false)(struct!.cacheTo),
    cgroup_parent: cdktn.stringToTerraform(struct!.cgroupParent),
    context: cdktn.stringToTerraform(struct!.context),
    cpu_period: cdktn.numberToTerraform(struct!.cpuPeriod),
    cpu_quota: cdktn.numberToTerraform(struct!.cpuQuota),
    cpu_set_cpus: cdktn.stringToTerraform(struct!.cpuSetCpus),
    cpu_set_mems: cdktn.stringToTerraform(struct!.cpuSetMems),
    cpu_shares: cdktn.numberToTerraform(struct!.cpuShares),
    dockerfile: cdktn.stringToTerraform(struct!.dockerfile),
    extra_hosts: cdktn.listMapper(cdktn.stringToTerraform, false)(struct!.extraHosts),
    force_remove: cdktn.booleanToTerraform(struct!.forceRemove),
    isolation: cdktn.stringToTerraform(struct!.isolation),
    label: cdktn.hashMapper(cdktn.stringToTerraform)(struct!.label),
    labels: cdktn.hashMapper(cdktn.stringToTerraform)(struct!.labels),
    memory: cdktn.numberToTerraform(struct!.memory),
    memory_swap: cdktn.numberToTerraform(struct!.memorySwap),
    network_mode: cdktn.stringToTerraform(struct!.networkMode),
    no_cache: cdktn.booleanToTerraform(struct!.noCache),
    platform: cdktn.stringToTerraform(struct!.platform),
    provenance: cdktn.stringToTerraform(struct!.provenance),
    pull_parent: cdktn.booleanToTerraform(struct!.pullParent),
    remote_context: cdktn.stringToTerraform(struct!.remoteContext),
    remove: cdktn.booleanToTerraform(struct!.remove),
    sbom: cdktn.stringToTerraform(struct!.sbom),
    security_opt: cdktn.listMapper(cdktn.stringToTerraform, false)(struct!.securityOpt),
    session_id: cdktn.stringToTerraform(struct!.sessionId),
    shm_size: cdktn.numberToTerraform(struct!.shmSize),
    squash: cdktn.booleanToTerraform(struct!.squash),
    suppress_output: cdktn.booleanToTerraform(struct!.suppressOutput),
    tag: cdktn.listMapper(cdktn.stringToTerraform, false)(struct!.tag),
    target: cdktn.stringToTerraform(struct!.target),
    use_legacy_builder: cdktn.booleanToTerraform(struct!.useLegacyBuilder),
    version: cdktn.stringToTerraform(struct!.version),
    auth_config: cdktn.listMapper(registryImageBuildAuthConfigToTerraform, true)(struct!.authConfig),
    secrets: cdktn.listMapper(registryImageBuildSecretsToTerraform, true)(struct!.secrets),
    ulimit: cdktn.listMapper(registryImageBuildUlimitToTerraform, true)(struct!.ulimit),
  }
}


export function registryImageBuildToHclTerraform(struct?: RegistryImageBuildOutputReference | RegistryImageBuild): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  const attrs = {
    additional_contexts: {
      value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(struct!.additionalContexts),
      isBlock: false,
      type: "list",
    ...
    build_id: {
      value: cdktn.stringToHclTerraform(struct!.buildId),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
    build_log_file: {
      value: cdktn.stringToHclTerraform(struct!.buildLogFile),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
    builder: {
      value: cdktn.stringToHclTerraform(struct!.builder),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
    cache_from: {
      value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(struct!.cacheFrom),
      isBlock: false,
      type: "list",
      storageClassType: "stringList",
    },
    cache_to: {
      value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(struct!.cacheTo),
      isBlock: false,
      type: "list",
      storageClassType: "stringList",
    },
    ...
    cpu_period: {
      value: cdktn.numberToHclTerraform(struct!.cpuPeriod),
      isBlock: false,
      type: "simple",
      storageClassType: "number",
    },
    cpu_quota: {
      value: cdktn.numberToHclTerraform(struct!.cpuQuota),
      isBlock: false,
      type: "simple",
      storageClassType: "number",
    },
    ...
    cpu_shares: {
      value: cdktn.numberToHclTerraform(struct!.cpuShares),
      isBlock: false,
      type: "simple",
      storageClassType: "number",
    },
    dockerfile: {
      value: cdktn.stringToHclTerraform(struct!.dockerfile),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
    extra_hosts: {
      value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(struct!.extraHosts),
      isBlock: false,
      type: "list",
      storageClassType: "stringList",
    },
    force_remove: {
      value: cdktn.booleanToHclTerraform(struct!.forceRemove),
      isBlock: false,
      type: "simple",
    ...
    label: {
      value: cdktn.hashMapperHcl(cdktn.stringToHclTerraform)(struct!.label),
      isBlock: false,
      type: "map",
      storageClassType: "stringMap",
    },
    ...
    memory_swap: {
      value: cdktn.numberToHclTerraform(struct!.memorySwap),
      isBlock: false,
      type: "simple",
      storageClassType: "number",
    },
    ...
    no_cache: {
      value: cdktn.booleanToHclTerraform(struct!.noCache),
      isBlock: false,
      type: "simple",
      storageClassType: "boolean",
    },
    ...
    provenance: {
      value: cdktn.stringToHclTerraform(struct!.provenance),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
    pull_parent: {
      value: cdktn.booleanToHclTerraform(struct!.pullParent),
      isBlock: false,
      type: "simple",
      storageClassType: "boolean",
    },
    remote_context: {
      value: cdktn.stringToHclTerraform(struct!.remoteContext),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
    remove: {
      value: cdktn.booleanToHclTerraform(struct!.remove),
      isBlock: false,
      type: "simple",
      storageClassType: "boolean",
    },
    sbom: {
      value: cdktn.stringToHclTerraform(struct!.sbom),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
    security_opt: {
      value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(struct!.securityOpt),
      isBlock: false,
      type: "list",
      storageClassType: "stringList",
    },
    ...
    shm_size: {
      value: cdktn.numberToHclTerraform(struct!.shmSize),
      isBlock: false,
      type: "simple",
      storageClassType: "number",
    },
    squash: {
      value: cdktn.booleanToHclTerraform(struct!.squash),
      isBlock: false,
      type: "simple",
      storageClassType: "boolean",
    },
    suppress_output: {
      value: cdktn.booleanToHclTerraform(struct!.suppressOutput),
      isBlock: false,
      type: "simple",
      storageClassType: "boolean",
    },
    tag: {
      value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(struct!.tag),
      isBlock: false,
      type: "list",
      storageClassType: "stringList",
    },
    ...
    use_legacy_builder: {
      value: cdktn.booleanToHclTerraform(struct!.useLegacyBuilder),
      isBlock: false,
      type: "simple",
      storageClassType: "boolean",
    },
    ...
    auth_config: {
      value: cdktn.listMapperHcl(registryImageBuildAuthConfigToHclTerraform, true)(struct!.authConfig),
      isBlock: true,
      type: "list",
      storageClassType: "RegistryImageBuildAuthConfigList",
    },
    secrets: {
      value: cdktn.listMapperHcl(registryImageBuildSecretsToHclTerraform, true)(struct!.secrets),
      isBlock: true,
      type: "list",
      storageClassType: "RegistryImageBuildSecretsList",
    },
    ulimit: {
      value: cdktn.listMapperHcl(registryImageBuildUlimitToHclTerraform, true)(struct!.ulimit),
      isBlock: true,
      type: "list",
...
export class RegistryImageBuildOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): RegistryImageBuild | undefined {
    ...
    if (this._sbom !== undefined) {
      hasAnyValues = true;
      internalValueResult.sbom = this._sbom;
    }
  ...
  private _additionalContexts?: string[]; 
  public get additionalContexts() {
    return this.getListAttribute('additional_contexts');
  }
  public set additionalContexts(value: string[]) {
    this._additionalContexts = value;
  }
  public resetAdditionalContexts() {
    this._additionalContexts = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get additionalContextsInput() {
  ...
  private _buildLogFile?: string; 
  public get buildLogFile() {
    return this.getStringAttribute('build_log_file');
  }
  public set buildLogFile(value: string) {
    this._buildLogFile = value;
  }
  public resetBuildLogFile() {
    this._buildLogFile = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get buildLogFileInput() {
  ...
  private _cacheTo?: string[]; 
  public get cacheTo() {
    return this.getListAttribute('cache_to');
  }
  public set cacheTo(value: string[]) {
    this._cacheTo = value;
  }
  public resetCacheTo() {
    this._cacheTo = undefined;
  ...
  private _forceRemove?: boolean | cdktn.IResolvable; 
  public get forceRemove() {
    return this.getBooleanAttribute('force_remove');
  }
  public set forceRemove(value: boolean | cdktn.IResolvable) {
  ...
  private _noCache?: boolean | cdktn.IResolvable; 
  public get noCache() {
    return this.getBooleanAttribute('no_cache');
  }
  public set noCache(value: boolean | cdktn.IResolvable) {
    this._noCache = value;
  }
  public resetNoCache() {
    this._noCache = undefined;
  ...
  private _pullParent?: boolean | cdktn.IResolvable; 
  public get pullParent() {
    return this.getBooleanAttribute('pull_parent');
  }
  public set pullParent(value: boolean | cdktn.IResolvable) {
  ...
  private _remove?: boolean | cdktn.IResolvable; 
  public get remove() {
    return this.getBooleanAttribute('remove');
  }
  public set remove(value: boolean | cdktn.IResolvable) {
    this._remove = value;
  }
  public resetRemove() {
    this._remove = undefined;
  ...
  private _squash?: boolean | cdktn.IResolvable; 
  public get squash() {
    return this.getBooleanAttribute('squash');
  }
  public set squash(value: boolean | cdktn.IResolvable) {
    this._squash = value;
  }
  public resetSquash() {
    this._squash = undefined;
  ...
  private _suppressOutput?: boolean | cdktn.IResolvable; 
  public get suppressOutput() {
    return this.getBooleanAttribute('suppress_output');
  }
  public set suppressOutput(value: boolean | cdktn.IResolvable) {
  ...
  private _useLegacyBuilder?: boolean | cdktn.IResolvable; 
  public get useLegacyBuilder() {
    return this.getBooleanAttribute('use_legacy_builder');
  }
  public set useLegacyBuilder(value: boolean | cdktn.IResolvable) {
    this._useLegacyBuilder = value;
  }
  public resetUseLegacyBuilder() {
    this._useLegacyBuilder = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get useLegacyBuilderInput() {
  ...
  public putAuthConfig(value: RegistryImageBuildAuthConfig[] | cdktn.IResolvable) {
  ...
  private _secrets = new RegistryImageBuildSecretsList(this, "secrets", false);
  public get secrets() {
    return this._secrets;
  }
  public putSecrets(value: RegistryImageBuildSecrets[] | cdktn.IResolvable) {
  ...
  public putUlimit(value: RegistryImageBuildUlimit[] | cdktn.IResolvable) {
...
export interface RegistryImageTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#create RegistryImage#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#delete RegistryImage#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#update RegistryImage#update}
  */
  readonly update?: string;
}

export function registryImageTimeoutsToTerraform(struct?: RegistryImageTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function registryImageTimeoutsToHclTerraform(struct?: RegistryImageTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class RegistryImageTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktn.IResolvable;
  ...
  */
  ...
  public get internalValue(): RegistryImageTimeouts | cdktn.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: RegistryImageTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class RegistryImage extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RegistryImage that should be imported. Refer to the {@link https://registry.terraform.io/providers/kreuzwerker/docker/4.6.0/docs/resources/registry_image#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _timeouts = new RegistryImageTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: RegistryImageTimeouts) {
